...
require (
	...
	github.com/cyberark/conjur-api-go v0.13.4 // version will be ignored by auto release process
...
replace github.com/cyberark/conjur-api-go => github.com/cyberark/conjur-api-go v0.13.7

replace github.com/cyberark/conjur-authn-k8s-client => github.com/cyberark/conjur-authn-k8s-client v0.26.8

replace github.com/cyberark/conjur-opentelemetry-tracer => github.com/cyberark/conjur-opentelemetry-tracer v0.0.3
...
replace golang.org/x/crypto v0.0.0-20190308221718-c2843e01d9a2 => golang.org/x/crypto v0.31.0

replace golang.org/x/crypto v0.0.0-20190510104115-cbcb75029529 => golang.org/x/crypto v0.31.0

replace golang.org/x/crypto v0.0.0-20190605123033-f99c8df09eb5 => golang.org/x/crypto v0.31.0

replace golang.org/x/crypto v0.0.0-20191011191535-87dc89f01550 => golang.org/x/crypto v0.31.0

replace golang.org/x/crypto v0.0.0-20201002170205-7f63de1d35b0 => golang.org/x/crypto v0.31.0

replace golang.org/x/crypto v0.0.0-20210921155107-089bfa567519 => golang.org/x/crypto v0.31.0

replace golang.org/x/crypto v0.0.0-20211215153901-e495a2d5b3d3 => golang.org/x/crypto v0.31.0

replace golang.org/x/crypto v0.0.0-20220214200702-86341886e292 => golang.org/x/crypto v0.31.0

replace golang.org/x/crypto v0.14.0 => golang.org/x/crypto v0.31.0
...
replace golang.org/x/net v0.0.0-20210503060351-7fd8e65b6420 => golang.org/x/net v0.33.0
...
replace golang.org/x/net v0.1.1-0.20221104162952-702349b0e862 => golang.org/x/net v0.33.0

replace golang.org/x/net v0.0.0-20220425223048-2871e0cb64e4 => golang.org/x/net v0.33.0

replace golang.org/x/net v0.4.0 => golang.org/x/net v0.33.0
...
replace golang.org/x/text v0.0.0-20170915032832-14c0d48ead0c => golang.org/x/text v0.21.0

replace golang.org/x/text v0.3.0 => golang.org/x/text v0.21.0

replace golang.org/x/text v0.3.1-0.20180807135948-17ff2d5776d2 => golang.org/x/text v0.21.0

replace golang.org/x/text v0.3.2 => golang.org/x/text v0.21.0

replace golang.org/x/text v0.3.3 => golang.org/x/text v0.21.0

replace golang.org/x/text v0.3.4 => golang.org/x/text v0.21.0

replace golang.org/x/text v0.3.5 => golang.org/x/text v0.21.0

replace golang.org/x/text v0.3.6 => golang.org/x/text v0.21.0
